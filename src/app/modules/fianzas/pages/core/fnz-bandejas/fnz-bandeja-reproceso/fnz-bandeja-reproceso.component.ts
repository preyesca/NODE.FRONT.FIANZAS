...
@Component({
  selector: 'app-fnz-bandeja-reproceso',
  templateUrl: './fnz-bandeja-reproceso.component.html',
  styleUrls: ['./fnz-bandeja-reproceso.component.scss']
})
export class FnzBandejaReprocesoComponent {
  ...
  onRowDoubleClick(row: IFnzBandejaPaginate): void {
    ...
    const paths = [
      ...
      { actividad: EFnzActividad.GENERACION_FORMATOS, path: 'generacion-formatos' },
      { actividad: EFnzActividad.FIRMA_DOCUMENTAL, path: 'firma-documental' },
      { actividad: EFnzActividad.RECOLECCION_DE_FISICOS, path: 'recoleccion-fisicos' },

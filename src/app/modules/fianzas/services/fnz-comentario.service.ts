...
import { IFnzComentario } from '../pages/core/helpers/interfaces/fnz-comentario';
import { IComentario, ISaveComentario } from '../../administracion/helpers/interfaces/core-comentario';

@Injectable({
  providedIn: 'root',
})
export class FnzComentarioService {
